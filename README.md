...
![Version: 5.0.12-bb.8](https://img.shields.io/badge/Version-5.0.12--bb.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: RELEASE.2024-03-26T22-10-45Z](https://img.shields.io/badge/AppVersion-RELEASE.2024--03--26T22--10--45Z-informational?style=flat-square)
...
| tenant.image.tag | string | `"RELEASE.2024-03-26T22-10-45Z"` |  |
...
| bbtests.scripts.image | string | `"registry1.dso.mil/ironbank/opensource/minio/mc:RELEASE.2024-03-25T16-41-14Z"` |  |
